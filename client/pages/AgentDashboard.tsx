  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: "#f0f4ff" }}>
      ...
      <motion.div
        ...
        className="fixed left-0 top-0 h-screen bg-white shadow-xl z-50 overflow-hidden border-r border-gray-200"
      >
        {/* Toggle Button */}
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 border-b border-gray-100">
              <motion.div
                ...
                className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-4 cursor-pointer shadow-sm border border-blue-200 transition-all duration-200 hover:shadow-md"
              >
          ...
          <div className="flex flex-col h-full items-center py-6">
            ...
            <div className="space-y-3">
              <motion.button
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="w-10 h-10 flex items-center justify-center rounded-lg text-gray-600 hover:bg-gray-100 transition-all duration-200 group"
                title="Help Center"
              >
                <HelpCircle className="w-5 h-5" />
                <div className="absolute left-14 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50 pointer-events-none">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={handleLogout}
                className="w-10 h-10 flex items-center justify-center rounded-lg text-gray-600 hover:bg-red-100 hover:text-red-600 transition-all duration-200 group"
                title="Logout"
              >
                <LogOut className="w-5 h-5" />
                <div className="absolute left-14 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-50 pointer-events-none">
